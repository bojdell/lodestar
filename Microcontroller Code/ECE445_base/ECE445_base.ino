...
#define TFT_SCLK   15
#define TFT_MOSI   16
Adafruit_ST7735 tft = Adafruit_ST7735(TFT_CS, TFT_DC, TFT_MOSI, TFT_SCLK, TFT_RST); // display
...
void setup(void) {
  Serial.begin(9600); // this might need to be bigger to accomodate printing NMEA sentences on serial monitor
